...
import 'package:soal_prioritas_2_dan_eksplorasi/page/widget/contact_form_header_widget.dart';
import 'package:soal_prioritas_2_dan_eksplorasi/page/widget/contact_form_widget.dart';
import 'package:soal_prioritas_2_dan_eksplorasi/page/widget/contact_list_item_widget.dart';
...
class _ContactsPageState extends State<ContactPage> {
  ...
  void editContact(int index) {
    setState(() {
      ...
      dueDate = contactList[index].date;
      selectedColor = contactList[index].color;
      selectedFile = contactList[index].file;
      isEditing = true;
      editingIndex = index;
    });
  }
